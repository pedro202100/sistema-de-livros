...
public class Atividade extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("insert")) {
			...
			try {
				dao.adiciona(livro);
				out.println("Livro " + livro.getTitulo() + " foi adicionado com sucesso");
			}catch(Throwable e) {
				out.println("Deu ERRO ao Adicionar um novo livro");
				e.printStackTrace();
			}
			...
			try {
				dao.remover(livro);
				out.println("Livro " + livro.getCodlivro() + " foi deletado com sucesso");
			}catch(Throwable e) {
				out.println("Deu ERRO ao excluir o livro solicitado");
				e.printStackTrace();
			}
			...
			try {
				dao.alterar(livro);
				out.println("Livro " + livro.getTitulo() + " foi alterado com sucesso");
			}catch(Throwable e) {
				out.println("Deu ERRO ao atualizar o livro solicitado");
				e.printStackTrace();
			}
		} 
	}
